...
//	public String urlJuego = "http://juego/";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispatch = request.getRequestDispatcher(urlUsuario + "usuario/" + request.getAttribute("id") + "/" + request.getAttribute("nombre") + "/" + request.getAttribute("codigo"));
